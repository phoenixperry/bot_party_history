...
public class TrainingTTTScriptPart : AbstractTTTScriptPart {
	...
	void partTwo() {
		SendNewTarget (TouchState.OneTwo,250, 0f);
	}
	void partThree() {
		SendNewTarget (TouchState.TwoThree,250, 1f);
	}
	void partFour() {
		SendNewTarget (TouchState.OneThree,250, 1f);
	}
	void partFive() {
		SendClearTargets ();
	...
	void partSix() {
		SendNewTarget (TouchState.AllConnected, 250, 1f);
	}
	void partSeven() {
		SendClearTargets ();
